        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="tools-ber">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-3 col-md-2">
                            <div class="select-filters">
                                <form action="{{ route('site.nile_curises') }}" method="GET" id="searchByPriceLevel">
            ...
            <div class="col-sm-12 col-md-12" id="searchBy">
                ...
                @elseif(isset($search['price']))
                    <h5 class="m-t-0 p-t-0" ><strong>Search result for price : <em>"{{ $search['price'] }}"</em></strong></h5>
            ...
            <div class="col-sm-4 col-md-3">
                ...
                <form action="{{ route('site.nile_curises') }}" method="GET" id="priceFilter">
                    <input type="hidden" name="from" id="from">
                    <input type="hidden" name="to" id="to">
                    <input type="hidden" name="type" value="nile_cruises">
                </form>
                ...
                <div class="sidber-box popular-post-widget">
                    <div class="cats-title">Popular Nile Cruises</div>
                    <div class="popular-post-inner">
                        @if(isset($popular_nileCruises))
                            @foreach($popular_nileCruises as $popular_nileCruise)
                                <div class="widget-activity-item">
                                    <div class="widget-activity-avatar">
                                        <img class="img-responsive" src="{{ asset('storage/packages/'.$popular_nileCruise->feature_image) }}" title="{{ $popular_nileCruise->title }}"> 
                                    </div>
                                    <div class="widget-activity-header">
                                      <a href="{{ route('site.popular_package.detail',[$popular_nileCruise->id]) }}">{{ $popular_nileCruise->title }}</a>
                                    </div>
                                </div>
                            @endforeach
                        @endif
...
<script type="text/javascript">
    ...
    if(night != '')
    {
        ...
        $('#searchBy').html('');
        $('#searchBy').html('<h5 class="m-t-0 p-t-0" ><strong>Search result for duration : <em>"'+text+'"</em></strong></h5>');
    ...
    {
        $('#searchBy').html('');
        $('#searchBy').html('<h5 class="m-t-0 p-t-0" ><strong>Search result for month of : <em>"'+monthNames[s_month-1]+'"</em></strong></h5>');
